...
#this script presumes that the UCI_Har_Dataset had been downloaded to a subdirectory 
#of the working directory called UCI_Har_Dataset.
...
ut.5 <- summarize_each(ut.4, funs(mean))    
